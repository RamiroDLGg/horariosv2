...
use App\Http\Controllers\ProyectoPersonalesController;
...
Route::middleware('auth')->group(function () {
    // Ruta para mostrar el índice del grupo de horarios
    Route::get('/rendimientos.index', [RendimientoController::class, 'index'])->name('rendimientos.index');

    // Rutas para las acciones CRUD de grupoHorario
    Route::resource('rendimientos', controller: RendimientoController::class);
...
Route::get('/reporte/excel', [ReportController::class, 'generarExcel'])->name('reporte.excel');
