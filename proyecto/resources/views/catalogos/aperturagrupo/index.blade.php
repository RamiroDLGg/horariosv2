                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox" name="horarios[Lunes][]" value="{{ $hora->hora_ini }}-{{ $hora->hora_fin }}"></td>
                                <td><input type="checkbox" name="horarios[Martes][]" value="{{ $hora->hora_ini }}-{{ $hora->hora_fin }}"></td>
                                <td><input type="checkbox" name="horarios[Miercoles][]" value="{{ $hora->hora_ini }}-{{ $hora->hora_fin }}"></td>
                                <td><input type="checkbox" name="horarios[Jueves][]" value="{{ $hora->hora_ini }}-{{ $hora->hora_fin }}"></td>
                                <td><input type="checkbox" name="horarios[Viernes][]" value="{{ $hora->hora_ini }}-{{ $hora->hora_fin }}"></td>
                            </tr>
